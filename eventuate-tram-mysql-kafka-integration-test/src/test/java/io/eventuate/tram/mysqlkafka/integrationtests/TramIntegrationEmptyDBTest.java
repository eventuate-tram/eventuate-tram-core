...
@SpringBootTest(classes = {EmptyDBTestConfiguration.class, TramIntegrationTestConfiguration.class})
public class TramIntegrationEmptyDBTest extends AbstractTramIntegrationTest{
